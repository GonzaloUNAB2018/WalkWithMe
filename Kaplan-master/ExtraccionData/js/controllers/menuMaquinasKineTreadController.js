app.controller("menuMaquinasKineTreadController", ['$scope', 'Notification', 'LoginService', '$location', 'consultaService',
function ($scope, Notification, LoginService, $location, consultaService) {
    ...
    if (!LoginService.getisAuthenticated() == true) {
        ...
        consultaService.getConsultaMaquinaKineTread().then(function (result) {
