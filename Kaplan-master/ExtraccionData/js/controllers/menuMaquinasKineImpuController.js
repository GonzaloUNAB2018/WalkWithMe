app.controller("menuMaquinasKineImpuController", ['$scope', 'Notification', 'LoginService', '$location', 'consultaService',
function ($scope, Notification, LoginService, $location, consultaService) {
    ...
    if (!LoginService.getisAuthenticated() == true) {
        ...
        consultaService.getConsultaMaquinaKineImpu().then(function (result) {
