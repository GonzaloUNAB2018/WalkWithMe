app.controller("menuMaquinasKineController", ['$scope', 'Notification', 'LoginService', '$location', 'consultaService',
function ($scope, Notification, LoginService, $location, consultaService) {
    ...
    if (!LoginService.getisAuthenticated() == true) {
        ...
        consultaService.getConsultaMaquinaKine().then(function (result) {
