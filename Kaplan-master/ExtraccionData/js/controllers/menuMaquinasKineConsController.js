app.controller("menuMaquinasKineConsController", ['$scope', 'Notification', 'LoginService', '$location', 'consultaService',
function ($scope, Notification, LoginService, $location, consultaService) {
    ...
    if (!LoginService.getisAuthenticated() == true) {
        ...
        consultaService.getConsultaMaquinaKineCons().then(function (result) {
